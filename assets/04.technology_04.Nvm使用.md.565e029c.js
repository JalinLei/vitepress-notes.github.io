import{_ as n,o as a,c as l,a as p}from"./app.eb270445.js";const D=JSON.parse('{"title":"Nvm使用","description":"","frontmatter":{},"headers":[{"level":2,"title":"安装","slug":"安装","link":"#安装","children":[]},{"level":2,"title":"Nvm 常用命令","slug":"nvm-常用命令","link":"#nvm-常用命令","children":[]}],"relativePath":"04.technology/04.Nvm使用.md"}'),o={name:"04.technology/04.Nvm使用.md"};function e(t,s,c,r,i,y){return a(),l("div",null,s[0]||(s[0]=[p(`<h1 id="nvm使用" tabindex="-1">Nvm使用 <a class="header-anchor" href="#nvm使用">¶</a></h1><p>nvm（node.js version management）是一个nodejs的版本管理工具，可以简单操作node版本的切换、安装、查看等。</p><h2 id="安装" tabindex="-1">安装 <a class="header-anchor" href="#安装">¶</a></h2><ol><li><p><a href="https://github.com/coreybutler/nvm-windows/releases" target="_blank" rel="noreferrer">下载安装</a></p></li><li><p>验证是否成功</p></li></ol><div class="language-bash"><button title="Copy Code" class="copy"></button><span class="lang">bash</span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#FFCB6B;">nvm</span><span style="color:#A6ACCD;"> </span><span style="color:#C3E88D;">-v</span></span>
...
<span class="line"></span></code></pre></div><div class="warning custom-block"><p class="custom-block-title">提示</p><p>使用命令时命令面板需使用管理员模式打开</p></div>`,10)]))}const m=n(o,[["render",e]]);export{D as __pageData,m as default};

import{_ as n,o as a,c as l,a as p}from"./app.eb270445.js";const D=JSON.parse('{"title":"开发标准","description":"","frontmatter":{},"headers":[{"level":2,"title":"统一注释","slug":"统一注释","link":"#统一注释","children":[]}],"relativePath":"01.basics/01.preknowledge/01.standard.md"}'),t={name:"01.basics/01.preknowledge/01.standard.md"};function e(o,s,c,i,r,y){return a(),l("div",null,s[0]||(s[0]=[p(`<h1 id="开发标准" tabindex="-1">开发标准 <a class="header-anchor" href="#开发标准">¶</a></h1><h2 id="统一注释" tabindex="-1">统一注释 <a class="header-anchor" href="#统一注释">¶</a></h2><div class="language-vue"><button title="Copy Code" class="copy"></button><span class="lang">vue</span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#676E95;font-style:italic;">&lt;!--------------------------------</span></span>
...
<span class="line"><span style="color:#676E95;font-style:italic;">============================================================================ */</span></span>
<span class="line"></span></code></pre></div>`,5)]))}const f=n(t,[["render",e]]);export{D as __pageData,f as default};
